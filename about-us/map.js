...
// //   });
// // });
// // === ПАТЧ для iOS та універсальність ===
// function addTapHandler(el) {
//   const handler = (e) => {
//     const cityName = el.getAttribute('data-name');
//     if (!cityName) return;
//     showOverlayForCity(cityName);
...
//   // дотик для iOS/Android
//   el.addEventListener('touchstart', handler, { passive: true });
// }

// // чіпляємо тільки до маркерів та груп міст
// document.querySelectorAll('.city-marker, g.city-group').forEach(addTapHandler);
...
// === ЄДИНИЙ УНІВЕРСАЛЬНИЙ ОБРОБНИК (Pointer Events) ===
